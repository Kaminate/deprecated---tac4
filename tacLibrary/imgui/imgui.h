...
typedef void* ImRendererID;          // user data to refer to a texture (e.g. store your texture handle/id)
...
namespace ImGui
{
    ...
    IMGUI_API void          Image(ImRendererID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0,0), const ImVec2& uv1 = ImVec2(1,1), const ImVec4& tint_col = ImVec4(1,1,1,1), const ImVec4& border_col = ImVec4(0,0,0,0));
    IMGUI_API bool          ImageButton(ImRendererID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0,0),  const ImVec2& uv1 = ImVec2(1,1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0,0,0,0), const ImVec4& tint_col = ImVec4(1,1,1,1));    // <0 frame_padding uses default frame padding settings. 0 for no padding
...
struct ImDrawCmd
{
    ...
    ImRendererID     RendererID;              // User-provided texture ID. Set by user in ImfontAtlas::SetTexID() for fonts or passed to Image*() functions. Ignore if never using images or multiple fonts atlas.
...
struct ImDrawList
{
    ...
    ImVector<ImRendererID>   _RendererIDStack;    // [Internal] 
    ...
    IMGUI_API void  PushRendererID(const ImRendererID& texture_id);
    IMGUI_API void  PopRendererID();
    ...
    IMGUI_API void  AddImage(ImRendererID user_texture_id, const ImVec2& a, const ImVec2& b, const ImVec2& uv0, const ImVec2& uv1, ImU32 col = 0xFFFFFFFF);
    ...
    IMGUI_API void  UpdateRendererID();
};
